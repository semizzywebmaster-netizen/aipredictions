  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <p className="mt-4 text-muted-foreground">All predictions are statistical estimates. No guaranteed profit. Past performance does not predict future results. Bet responsibly.</p>
