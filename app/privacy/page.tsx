  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <p className="mt-4 text-muted-foreground">We handle your data responsibly. Frontend-only, no secrets stored in client. Backend handles authentication and data protection.</p>
