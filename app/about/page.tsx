...
export const metadata = { title: 'About PUNTER PREDICTION' }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-3xl font-bold tracking-tight">About PUNTER PREDICTION</h1>
        <p className="mt-4 text-muted-foreground">Professional sports prediction intelligence platform with equal depth for football and basketball. AI-powered analytics, responsible insights, community-driven.</p>
