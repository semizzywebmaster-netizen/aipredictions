...
export const metadata = { title: 'Responsible Betting' }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-3xl font-bold tracking-tight">Responsible Betting</h1>
        <p className="mt-4 text-muted-foreground">18+ only. Predictions are analytical insights, not guarantees. Set limits, take breaks, seek help if needed. Never chase losses.</p>
